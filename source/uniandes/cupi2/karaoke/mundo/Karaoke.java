...
public class Karaoke
{
	...
	{
		try {
                    int resultado = darCantidadCancionesRockYPop();
                    return "La cantidad de canciones de Rock y Pop es: " + resultado;
                } catch (Exception e){
                    return e.getMessage();
                }
	}
